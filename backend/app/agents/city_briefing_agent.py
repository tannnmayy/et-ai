...
from backend.app.agents.tools import tool_get_city_briefing, tool_get_inspection_priorities

logger = logging.getLogger(__name__)

PERMITTED_TOOLS = ["tool_get_city_briefing", "tool_get_inspection_priorities"]
