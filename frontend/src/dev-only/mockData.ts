...
export const mockPriorities: PriorityHex[] = [
  ...
  },
  {
    ...
    isMajorRoadCorridor: true,
    trafficCorridorScore: 0.8,
    isPeakHour: true,
    trafficTimeMultiplier: 1.4,
    lat: 12.9176,
    lng: 77.6244,
  },
  {
  ...
  },
  {
    ...
    actionTier: 'MONITOR',
    pm25: 115,
    primarySource: 'Burning',
    primarySourceKey: 'burning',
