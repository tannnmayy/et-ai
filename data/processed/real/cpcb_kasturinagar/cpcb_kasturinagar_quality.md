...
Generated at (UTC): 2026-07-07T15:59:01.895744+00:00

## Source
- Raw file: `E:\1ETAI\data\raw\cpcb\kasturi_nagar_bengaluru_kspcb_15m.csv`
- Station: `Kasturi Nagar` (`cpcb_kasturinagar`)
- Source label: KSPCB
...
- no2: 13.81%
- temperature_c: 14.56%
- relative_humidity: 25.35%
- wind_speed_mps: 14.56%
- rainfall_mm: 0.0%

## Hourly PM2.5 Controls
- Minimum PM2.5 observations per hour: 2
- Hours excluded for insufficient PM2.5: 1196
- Longest continuous hourly PM2.5 run (hours): 650
- PM2.5 gaps longer than 24 hours: 15

## Rainfall
RF appears cumulative (mostly non-decreasing). Interval rainfall is derived as positive hour-over-hour differences with negative diffs treated as reset/null.
